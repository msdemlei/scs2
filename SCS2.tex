...
Operators already running a ConeSearch-1 services should keep doing so
until the transition team declares the migration window closed, even
while the tables are accessible through SCS2 already.

While ideally, newly implemented SCS2 services should be accompanied
by ConeSearch-1 interfaces in order to keep legacy clients viable for as
long as possible, it is deemed acceptable that these legacy client will
